  ...
  const pastEvents = [
    {
      ...
      location: "New Mexico, USA",
      description:
        "Team Sammard placed in the top 10 at the Intercollegiate Rocket Engineering Competition.",
      image: "/placeholder.svg?height=800&width=1200",
    ...
    },
    {
      ...
      description:
        "National-level CanSat competition where Team Sammard secured 2nd place.",
      image: "/placeholder.svg?height=800&width=1200",
      result: "2nd Place",
    },
    {
      ...
      location: "VIT Vellore",
      description:
        "Two-day workshop on rocket propulsion systems and performance optimization.",
      image: "/placeholder.svg?height=800&width=1200",
    ...
    },
    {
      ...
      location: "VIT Vellore",
      description:
        "Exhibition showcasing Team Sammard's rockets and aerospace projects to inspire young students.",
      image: "/placeholder.svg?height=800&width=1200",
      result: "500+ Visitors",
    },
    {
      ...
      description:
        "International CanSat competition where Team Sammard represented India.",
      image: "/placeholder.svg?height=800&width=1200",
    ...
    },
    {
      ...
      location: "IIT Madras",
      description:
        "National competition focused on designing flight computers and telemetry systems.",
      image: "/placeholder.svg?height=800&width=1200",
      result: "1st Place",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-4">
                Intercollegiate Rocket Engineering Competition (IREC) 2025
              </h3>
              <p className="text-muted-foreground mb-6">
                The world's largest collegiate rocket engineering competition,
                bringing together teams from around the globe to launch solid,
                liquid, and hybrid rockets to target altitudes of 10,000 or
                30,000 feet.
              </p>
